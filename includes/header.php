    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav mr-auto">
          ...
          <a class="nav-item nav-link" href="form_registration.php">Registration <span class="sr-only">(current)</span></a>
          <a class="nav-item nav-link" href="viewrecords.php">View Attendees</a>
        </div>
        <div class="navbar-nav ml-auto">
          <?php 
              if(!isset($_SESSION['userid'])){ # kui id määramata siis näita Login
          ?>
          ...
          <?php } else { ?>
            ...
            <a class="nav-item nav-link" href="list_users.php">Admin <span class="sr-only">(current)</span></a>
          <?php } ?>
        </div>
      </div>
    </nav>
